...
function renderClient(c){
  currentClient=c;
  const videoTab=document.querySelector('[data-view="videos"]');
  if(videoTab)videoTab.hidden=!c.modules?.video;
  if(!c.modules?.video&&videoTab?.classList.contains("active"))showView("overview");
