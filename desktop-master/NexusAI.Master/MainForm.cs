...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        Shown += async (_, _) =>
        {
            ...
            if (!runtimeReady)
            {
                statusLabel.Text = "Componente WebView2 não instalado. Instale-o e abra o NEXUS AI MASTER novamente.";
                ShowLogin(true);
                return;
            }
...
internal static class WebView2Runtime
{
    ...
    public static async Task<bool> EnsureInstalledAsync(Form owner)
    {
        ...
        var proceed = MessageBox.Show(
            owner,
            "O NEXUS AI MASTER precisa instalar um componente da Microsoft (WebView2 Runtime) na primeira vez que roda neste computador. Isso acontece uma única vez.\n\nDeseja instalar agora?",
            "NEXUS AI MASTER - Instalação necessária",
